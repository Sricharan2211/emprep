...
List<Employee> employees = new List<Employee>() 
    {
       new Employee() { Id = 1, Name = "Viyaj", Designation = "Developer", DOJ = new DateTime(day: 12, month: 11, year:2022)},
       ...
       new Employee() { Id = 5, Name = "Sini", Designation = "Manager", DOJ = new DateTime(day: 12, month: 11, year:2023)},
